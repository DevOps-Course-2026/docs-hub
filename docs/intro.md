...
- A sync workflow in each repo automatically pushes content here on every commit
- The sidebar is **fully auto-generated** — no manual updates needed as content grows
...
:::tip
New to the portal? Start with **Platform → Auto-Sync** to understand how this hub is structured.
:::
